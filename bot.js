...
const channelID = '601121704915501057'
...
client.on('ready', () => {
    ...
    client.user.setActivity("MADE BY it's me mario#5713", { type: "PLAYING" })
})
...
client.login("NTk0ODI0MzMxMzA2MDc0MTI0.XRiDXw.WCTVjmFkEcciIUBCrCZpszASr20");
